...
class GCRes2NeXt(PickableSequentialChain):
    ...
    def __init__(self, n_layer, n_class=None,
        ...
        kwargs = {
            ...
            'stride_first': False, 'add_block': 'gc'}

        super(GCRes2NeXt, self).__init__()
...
class GCRes2NeXt50(GCRes2NeXt):

    def __init__(self, n_class=None, initialW=None, fc_kwargs={}):
        super(GCRes2NeXt50, self).__init__(
            50, n_class, initialW, fc_kwargs)


class GCRes2NeXt101(GCRes2NeXt):

    def __init__(self, n_class=None, initialW=None, fc_kwargs={}):
        super(GCRes2NeXt101, self).__init__(
            101, n_class, initialW, fc_kwargs)


class GCRes2NeXt152(GCRes2NeXt):

    def __init__(self, n_class=None, initialW=None, fc_kwargs={}):
        super(GCRes2NeXt152, self).__init__(
