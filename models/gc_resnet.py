...
class GCResNet(PickableSequentialChain):
    ...
    def __init__(self, n_layer, n_class=None,
        ...
        kwargs = {
            'initialW': initialW, 'stride_first': True, 'add_block': 'gc'}
...
class GCResNet50(GCResNet):

    def __init__(self, n_class=None, initialW=None, fc_kwargs={}):
        super(GCResNet50, self).__init__(
            50, n_class, initialW, fc_kwargs)


class GCResNet101(GCResNet):

    def __init__(self, n_class=None, initialW=None, fc_kwargs={}):
        super(GCResNet101, self).__init__(
            101, n_class, initialW, fc_kwargs)


class GCResNet152(GCResNet):

    def __init__(self, n_class=None, initialW=None, fc_kwargs={}):
        super(GCResNet152, self).__init__(
